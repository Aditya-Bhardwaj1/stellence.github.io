...
import FormulationsTechnology from './components/FormulationsTechnology/FormulationsTechnology';
...
function App() {
  return (<>
    ...
    <Routes>
     ...
     <Route exact path='/aboutus/timelinenew' element={<TimelineNew/>}/>  
     ...
     <Route exact path='/technology/FormulationsTechnology' element={<FormulationsTechnology/>}/>
